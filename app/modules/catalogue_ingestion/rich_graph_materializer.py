            ...
            if entity_type is ClaimEntityType.ELIGIBILITY:
                ...
                entity = FundingComponent(
                    **common,
                    ...
                    unit=_optional_single_text(fields, "unit"),
                    qualifier=_joined_text(fields, "qualifier"),
                    original_text=_joined_text(fields, "original_text"),
                    description=_joined_text(fields, "description"),
                )
                ...
                entity = OpportunityResource(
                    **common,
                    ...
                    url=_optional_single_text(fields, "url"),
                    contact_type=_optional_single_text(fields, "contact_type"),
                    organization=_optional_single_text(fields, "organization"),
                    contact_name=_optional_single_text(fields, "contact_name"),
                    email=_optional_single_text(fields, "email"),
                    phone=_optional_single_text(fields, "phone"),
                    address=_joined_text(fields, "address"),
                    original_text=_joined_text(fields, "original_text"),
