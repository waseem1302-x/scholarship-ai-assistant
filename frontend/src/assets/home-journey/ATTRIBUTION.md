# Homepage journey image attribution

All images are stored locally and were cropped, resized, and color-graded for the homepage card format. Source metadata was verified through the source records indexed by Openverse and Wikimedia Commons.
...
| `prepare-research.webp` | Chair Notebook | Oliver Klein | [CC0 1.0](https://creativecommons.org/publicdomain/zero/1.0/) | [StockSnap](https://stocksnap.io/photo/chair-notebook-7ZPSYLVQNC) |
...
| `prepare-documents.webp` | Filefolders Business | Michal Kulesza | [CC0 1.0](https://creativecommons.org/publicdomain/zero/1.0/) | [StockSnap](https://stocksnap.io/photo/filefolders-business-6RHKEELJ8F) |
| `prepare-plan.webp` | Woman Writing | JESHOOTS.com | [CC0 1.0](https://creativecommons.org/publicdomain/zero/1.0/) | [StockSnap](https://stocksnap.io/photo/woman-writing-FFSUL8TZD3) |
