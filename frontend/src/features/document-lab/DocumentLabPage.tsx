...
export function DocumentLabPage() {
  ...
  return <main className="workspace-page page-width document-lab-page">
    <section className="workspace-intro"><p className="eyebrow">Private Documents</p><h1>Editorial feedback, under your control.</h1><p>Use CVs, resumes, statements of purpose, personal statements, and motivation letters only. Feedback is not an eligibility, admission, funding, visa, plagiarism, or authorship decision.</p></section>
    {!policy ? <p aria-live="polite">Loading private Documents settings…</p> : !policy.enabled ? <section className="assistant-warning" role="alert"><strong>Documents are unavailable</strong><p>This deployment has not enabled the private storage, scanner, and worker configuration.</p></section> : <>
